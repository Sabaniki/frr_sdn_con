...
type BgpIpv6SummaryPeerInfo struct {
	...
	PeerUptimeMsec             int32  `protobuf:"varint,10,opt,name=peerUptimeMsec,proto3" json:"peerUptimeMsec,omitempty"`
	PeerUptimeEstablishedEpoch int32  `protobuf:"varint,11,opt,name=peerUptimeEstablishedEpoch,proto3" json:"peerUptimeEstablishedEpoch,omitempty"`
...
func (x *BgpIpv6SummaryPeerInfo) GetPeerUptimeMsec() int32 {
	if x != nil {
...
func (x *BgpIpv6SummaryPeerInfo) GetPeerUptimeEstablishedEpoch() int32 {
	if x != nil {
...
var file_proto_api_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x0e, 0x70, 0x65, 0x65, 0x72, 0x55, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x4d, 0x73,
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x05, 0x52, 0x1a, 0x70, 0x65, 0x65, 0x72, 0x55, 0x70, 0x74, 0x69,
