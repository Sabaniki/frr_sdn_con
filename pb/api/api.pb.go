...
type InterfaceInfo struct {
	...
	EvpnMh               []byte           `protobuf:"bytes,19,opt,name=evpnMh,proto3" json:"evpnMh,omitempty"` // わからないのでとりあえず bytes に
...
func (x *InterfaceInfo) GetEvpnMh() []byte {
	if x != nil {
		return x.EvpnMh
	}
	return nil
...
var file_proto_api_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x06, 0x65, 0x76, 0x70, 0x6e, 0x4d, 0x68, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x72,
